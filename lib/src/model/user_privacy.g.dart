...
UserPrivacy _$UserPrivacyFromJson(Map<String, dynamic> json) => UserPrivacy(
  ...
  profileVisibility: $enumDecode(
    _$ProfileVisibilityEnumMap,
    json['profileVisibility'],
  ),
  locationPrivacy: $enumDecode(
  ...
  allowMessagesFrom: $enumDecode(
    _$ProfileVisibilityEnumMap,
    json['allowMessagesFrom'],
  ),
  allowLikesFrom: $enumDecode(
    _$ProfileVisibilityEnumMap,
    json['allowLikesFrom'],
  ),
...
Map<String, dynamic> _$UserPrivacyToJson(
  UserPrivacy instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'allowMessagesFrom': _$ProfileVisibilityEnumMap[instance.allowMessagesFrom]!,
