...
abstract mixin class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String status, int code, T data, String? message});
}
...
extension ApiResponsePatterns<T> on ApiResponse<T> {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String status, int code, T data, String? message)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiResponse() when $default != null:
        return $default(_that.status, _that.code, _that.data, _that.message);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String status, int code, T data, String? message) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _ApiResponse():
...
mixin _$PaginatedResponse {
  ...
  $PaginatedResponseCopyWith<PaginatedResponse> get copyWith =>
      _$PaginatedResponseCopyWithImpl<PaginatedResponse>(
          this as PaginatedResponse, _$identity);
...
abstract mixin class $PaginatedResponseCopyWith<$Res> {
  factory $PaginatedResponseCopyWith(
          PaginatedResponse value, $Res Function(PaginatedResponse) _then) =
...
extension PaginatedResponsePatterns on PaginatedResponse {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PaginatedResponse value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<dynamic> items, int total, int page, int limit,
    ...
    switch (_that) {
      case _PaginatedResponse() when $default != null:
        return $default(_that.items, _that.total, _that.page, _that.limit,
            _that.hasNext, _that.hasPrev);
      case _:
        return orElse();
    }
  }
...
class _PaginatedResponse implements PaginatedResponse {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$PaginatedResponseToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PaginatedResponseCopyWith<$Res>
    implements $PaginatedResponseCopyWith<$Res> {
  factory _$PaginatedResponseCopyWith(
          _PaginatedResponse value, $Res Function(_PaginatedResponse) _then) =
...
extension SuccessResponsePatterns on SuccessResponse {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String status, int code, String message)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SuccessResponse() when $default != null:
        return $default(_that.status, _that.code, _that.message);
      case _:
        return orElse();
    }
  }
...
extension ErrorResponsePatterns on ErrorResponse {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String status, int code, String message, String? error,
            Map<String, dynamic>? details)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ErrorResponse() when $default != null:
        return $default(_that.status, _that.code, _that.message, _that.error,
            _that.details);
      case _:
        return orElse();
    }
