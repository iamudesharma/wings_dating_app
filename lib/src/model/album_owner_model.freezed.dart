...
mixin _$AlbumOwnerModel {
 ...
 String get id; String get username; String get profilePicture;
/// Create a copy of AlbumOwnerModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AlbumOwnerModelCopyWith<AlbumOwnerModel> get copyWith => _$AlbumOwnerModelCopyWithImpl<AlbumOwnerModel>(this as AlbumOwnerModel, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AlbumOwnerModel&&(identical(other.id, id) || other.id == id)&&(identical(other.username, username) || other.username == username)&&(identical(other.profilePicture, profilePicture) || other.profilePicture == profilePicture));
}
...
abstract mixin class $AlbumOwnerModelCopyWith<$Res>  {
  factory $AlbumOwnerModelCopyWith(AlbumOwnerModel value, $Res Function(AlbumOwnerModel) _then) = _$AlbumOwnerModelCopyWithImpl;
@useResult
$Res call({
 String id, String username, String profilePicture
});
...
/// Create a copy of AlbumOwnerModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? username = null,Object? profilePicture = null,}) {
