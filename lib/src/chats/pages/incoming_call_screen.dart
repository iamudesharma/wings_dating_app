...
//   CubeSettings.instance.applicationId = AppConst.cubeappId;
//   CubeSettings.instance.authorizationKey = AppConst.authKey;
//   CubeSettings.instance.authorizationSecret = AppConst.authSecret;
//   CubeSettings.instance.onSessionRestore = () async {
//     final cubeUser = SharedPrefs.instance.getUser();
//     return await createSession(cubeUser);
//   };
// }
