...
mixin _$ProfileState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.albumImages, albumImages) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(albumImages),
      isLoading,
      error);
    ...
    return _then(_self.copyWith(
      ...
      profileImage: freezed == profileImage
          ...
          : profileImage // ignore: cast_nullable_to_non_nullable
              as Uint8List?,
      albumImages: null == albumImages
          ? _self.albumImages
          : albumImages // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
extension ProfileStatePatterns on ProfileState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(UserModel? userModel, Uint8List? profileImage,
            List<String> albumImages, bool isLoading, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ProfileState() when $default != null:
        return $default(_that.userModel, _that.profileImage, _that.albumImages,
...
class _ProfileState implements ProfileState {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.profileImage, profileImage) &&
            const DeepCollectionEquality()
                .equals(other._albumImages, _albumImages) &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.error, error) || other.error == error));
  }
  ...
  int get hashCode => Object.hash(
      ...
      userModel,
      const DeepCollectionEquality().hash(profileImage),
      const DeepCollectionEquality().hash(_albumImages),
      isLoading,
      error);
